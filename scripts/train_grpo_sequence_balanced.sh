...
# Policy-loss aggregation ablation: only token-mean -> per-sequence token mean.
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen3_8b_gov_agent_grpo_b16r4_rewardv2_seqbalanced_25step}"
