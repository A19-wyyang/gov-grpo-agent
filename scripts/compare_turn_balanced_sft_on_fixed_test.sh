...
CANDIDATE_EXPERIMENT="${CANDIDATE_EXPERIMENT:-qwen3_8b_gov_agent_grpo_b16r4_rewardv2_turnbalanced_sft_25step}"

BASELINE_EXPERIMENT="${BASELINE_EXPERIMENT}" \
  CANDIDATE_EXPERIMENT="${CANDIDATE_EXPERIMENT}" \
  BASELINE_SFT_ADAPTER="${PROJECT_DIR}/outputs/sft-qwen3-8b-diverse-v2/final_adapter" \
  CANDIDATE_SFT_ADAPTER="${PROJECT_DIR}/outputs/sft-qwen3-8b-diverse-v2-turn-balanced/final_adapter" \
