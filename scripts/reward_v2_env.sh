...
export GOV_ACTION_AFTER_DONE_PENALTY="${GOV_ACTION_AFTER_DONE_PENALTY:-0.10}"
export GOV_REPEATED_TOOL_PENALTY="${GOV_REPEATED_TOOL_PENALTY:-0.05}"
export GOV_TOOL_ORDER_PENALTY="${GOV_TOOL_ORDER_PENALTY:-0.10}"
export GOV_EARLY_ELIGIBILITY_PENALTY="${GOV_EARLY_ELIGIBILITY_PENALTY:-0.15}"
