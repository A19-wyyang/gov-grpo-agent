...
# SFT-loss ablation: GRPO data, reward, H8, B16xR4 and optimizer stay fixed.
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-1,2}"
export SFT_ADAPTER="${SFT_ADAPTER:-${PROJECT_DIR}/outputs/sft-qwen3-8b-diverse-v2-turn-balanced/final_adapter}"
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen3_8b_gov_agent_grpo_b16r4_rewardv2_turnbalanced_sft_25step}"
